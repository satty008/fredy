...
import aiProviderPlugin from './routes/aiProviderRouter.js';
import ratingSettingsPlugin from './routes/ratingSettingsRouter.js';
...
fastify.register(async (app) => {
  ...
  app.register(aiProviderPlugin, { prefix: '/api/aiProviders' });
  app.register(ratingSettingsPlugin, { prefix: '/api/user/ratingSettings' });
