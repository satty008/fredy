  ...
  fastify.get('/table', async (request) => {
    ...
    const withVerdict = (page) => ({
      ...
      result: page.result.map((listing) => ({
        ...listing,
        affordabilityVerdict: thresholds == null ? null : verdictForListing(listing.price, listing.dealType, thresholds),
        ...
        immocockpitVerdict: immocockpitVerdictFor(listing)?.verdict ?? null,
      })),
    });
