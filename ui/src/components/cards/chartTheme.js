 ...
 *
 * Deliberately not theme-aware like the tokens above: these badges (AI verdict, IC verdict, price
 * factor) read fine at this fixed saturation in both the dark and the new light theme, and tying
 * them to CSS custom properties that don't exist yet for a four-state (incl. "none") palette isn't
 * worth doing until the light theme actually needs it.
 */
